    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-MU3EML4\\SQLEXPRESS;Database=DepartmentAndEmployees;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public Employee GetEmployeeById(int id)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = $"select employee.firstname, employee.lastname, employee.departmentname from employee where employee.id = {id}";
                    SqlDataReader reader = cmd.ExecuteReader();
